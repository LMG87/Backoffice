<template>
    <h1 class="mt-4">Gestión Aliados</h1>
        ...
        <div class="col-md-6 col-sm-12">
            <div class="card card-body">
                <div class="list-group">
                    <router-link :to="{ name: 'panel_aliados' }" class="list-group-item">
                        <i class="fas fa-solid fa-table-columns me-2"></i>
                        Panel general
                    </router-link>

                    <router-link :to="{ name: 'panel_agentes' }" class="list-group-item">
                        <i class="fas fa-solid fa-user-secret me-2"></i>
                        Agentes
                    </router-link>
                    <router-link :to="{ name: 'beneficios' }" class="list-group-item">
                        <i class="fas fa-solid fa-list-check me-2"></i>
                        Beneficios
                    </router-link>
                    <router-link :to="{ name: 'top_aliados' }" class="list-group-item">
...
import useAliados from '@/modules/dashboard/composables/useAliados';
...
export default {
    ...
    setup(props) {
        ...
        if (!props.session) router.push({ name: 'login' })
